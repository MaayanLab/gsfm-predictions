      ...
      <div className="bg-transparent text-secondary-content flex flex-col justify-around">
        <div className="flex flex-row justify-between border-y-1 border-[#6992C8] bg-secondary">
          <Link className="flex flex-row gap-2 overflow-clip p-8 shrink-0" href="/">
            <img style={{ width: '372.88px' }} src="/resources/Logo.svg" />
          </Link>
        ...
        <div className="flex flex-row gap-8 h-[233px]">
          ...
          <nav className="flex flex-col p-8 gap-4">
            ...
            <a className="font-semibold link link-hover" href="https://github.com/maayanlab/gsfm-predictions" target='_blank'>Source Code <img className="inline-block" src="/resources/LinkOutIcon.svg" /></a>
          </nav>
          <div className="grow">&nbsp;</div>
          <img className="shrink-0" src="/resources/Ellipse2.svg" />
        </div>
        <div className="py-6 px-8 border-[#6992C8] border-t-1 font-semibold bg-secondary text-sm">
          Clarke, D. J. B. et al. A Gene Set Foundation Model Pre-Trained on a Massive Collection of Diverse Gene Sets. Preprint on bioRxiv (2025). <a href="https://doi.org/10.1101/2025.05.30.657124" target="_blank">doi:10.1101/2025.05.30.657124</a>
        </div>
      </div>
    </>
  )
