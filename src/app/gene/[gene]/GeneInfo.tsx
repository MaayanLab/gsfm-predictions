      ...
      <div className="flex flex-col items-stretch place-items-stretch overflow-auto">
        <div role="tablist" className="tabs tabs-lift tabs-xl min-w-max">
          {(ncbi_available || gpt4o_available || gemini_available) && <>
            <button
              role="tab"
              className={classNames("tab", { 'tab-active': searchParams.get('geneinfo') === null })}
          ...
          {gpt4o_available && gene_info.deepdive_gpt4o_description && <>
            <button
              role="tab"
              className={classNames("tab", { 'tab-active': searchParams.get('geneinfo') === 'gpt4o' })}
          ...
          {gemini_available && gene_info.deepdive_gemini_description && <>
            <button
              role="tab"
              className={classNames("tab", { 'tab-active': searchParams.get('geneinfo') === 'gemini' })}
          ...
          {!ncbi_available && !gpt4o_available && !gemini_available && <>
            <button
              role="tab"
              className={classNames("tab tab-active")}
            >
              Coming Soon
            </button>
          </>}
