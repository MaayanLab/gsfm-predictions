      ...
      <main className="container mx-auto flex flex-col gap-4 items-stretch flex-grow">
        <div className="prose max-w-full border p-4">
          ...
          <div role="tablist" className="tabs tabs-lifted tabs-lg">
            <input type="radio" name="my_tabs_2" role="tab" className="tab whitespace-nowrap" aria-label="NCBI Description" disabled={!gene_info.description} defaultChecked />
            ...
            <input type="radio" name="my_tabs_2" role="tab" className="tab whitespace-nowrap" aria-label="AI Overview" disabled={!gene_info.ai_description} defaultChecked={!gene_info.description} />
            <div role="tabpanel" className="tab-content bg-base-100 border-base-300 rounded-box px-6 prose prose-xl max-w-none">
              <div className="prose-p:m-0" dangerouslySetInnerHTML={{ __html: gene_info.ai_description ?? '' }} />
              <p><i>Generated by summarizing the top 50 most cited paper abstracts that mention this gene using gpt4o-mini (DeepDive).</i></p>
            </div>

            {!gene_info.description && !gene_info.ai_description && <>
              <input type="radio" name="my_tabs_2" role="tab" className="tab whitespace-nowrap" aria-label="Coming Soon" defaultChecked />
              <div role="tabpanel" className="tab-content bg-base-100 border-base-300 rounded-box px-6 prose prose-xl max-w-none">
