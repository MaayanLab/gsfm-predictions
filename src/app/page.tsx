...
export default function Home() {
  ...
  return (
    <main className="container mx-auto flex flex-col place-items-center items-center grow gap-4 my-4">
      ...
      <img className="px-16 mr-24" src="/benchmark.png" alt="GSFM Benchmark Results" />
      <div className="prose text-justify">
        <p><strong>Figure 1.</strong> Median area under the receiver operating characteristic curve (AUROC) across all terms in each benchmarking library. Ge20[Rummagene] & Ge20[Rummageo] are the models used for predictions on this site. PrismExp & Sim are the current state of the art methods used for gene function prediction on different underlying data sources.</p>
      </div>
    </main>
  )
}
